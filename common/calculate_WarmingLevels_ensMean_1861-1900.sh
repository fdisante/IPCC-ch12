...
#echo $gcm
# if [ -a ${region}/${sim}_${S2}_${S3}_${S4}_${S5}-${S6}.nc ] ; then
#   echo ${region}/${sim}_${S2}_${S3}_${S4}_${S5}-${S6}.nc PRESENT!!!
# else
...
# fi
if [ -a ${region}/${sim}_${S2}_${S3}_${S4}_${S5}-${S6}_Q100.nc ] ; then
  echo ${region}/${sim}_${S2}_${S3}_${S4}_${S5}-${S6}_Q100.nc PRESENT!!!
else
